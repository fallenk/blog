...
![](./Docker快速入门/images/DockerAndVirtualMachine.png)
...
`echo "Hello World"`
![](./Docker快速入门/images/dockerUbuntu.png)
...
```
这时刷新浏览器，我们发现效果变了。
![](./Docker快速入门/images/editNginx.png)
...
![](./Docker快速入门/images/rundocker.png)
...
![](./Docker快速入门/images/dockercloud.png)
